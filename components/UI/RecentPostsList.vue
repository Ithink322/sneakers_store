<template>
  <div class="recent-posts">
    ...
    <div class="recent-posts__btns btns">
    ...
    <div class="recent-posts__overflow">
...
onMounted(() => {
  ...
  SlideWidth =
    document.querySelector<HTMLElement>(".recent-posts-card")!.offsetWidth;
  SlidesLength = document.querySelectorAll(".recent-posts-card").length;
  gap = parseFloat(
  ...
  SliderWrapper!.style.transform = "translateX(0)";
  /* touchscreen sliders for .recent-posts__overflow ends */
});
