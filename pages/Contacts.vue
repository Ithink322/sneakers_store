    ...
    <section class="send-question">
      <form @submit.prevent="submitForm" class="send-question-form">
        ...
        <div
          ...
          class="send-question-form__main-flex main-flex"
        >
      ...
      <form @submit.prevent="submitForm" class="send-question-form">
        ...
        <div class="send-question-form__main-flex main-flex">
          <div class="main-flex__two-inputs-flex--from768px">
            ...
            />
            <span v-if="nameIsEmpty" class="main-flex__notice"
              >Важно заполнить это поле.</span
            >
            <input
              v-model="email"
            ...
            />
            <span v-if="emailIsEmpty" class="main-flex__notice"
              >Важно заполнить это поле.</span
            >
            <span v-if="!emailIsValid" class="main-flex__notice"
              >Введите корректный email.</span
            >
          </div>
          <input
          ...
          <button class="main-flex__btn">Отправить</button>
          <span class="main-flex__note"
            >Нажимая кнопку “Отправить” я соглашаюсь с<span
              class="main-flex__note--underlined"
              >политикой конфиденциальности</span
            ></span
          >
        </div>
