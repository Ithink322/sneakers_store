    ...
    <div v-if="isContainerVisible" class="leave-review-shadow">
      <div class="leave-review">
          ...
          <div @click="triggerFileInput" class="leave-review__img-upload-area">
            ...
            <div v-else class="leave-review__img-preview">
              ...
              >
                ...
                >
                  <img src="/imgs/cross-round-borders.png" alt="" />
                </button>
        ...
        >
          ...
          <!-- <div class="thanks-message__tick">
            <svg
              width="30"
              height="21"
              viewBox="0 0 30 21"
          ...
          <span class="thanks-message__text"
            >Спасибо, ваш отзыв<br
              class="thanks-message__text-br--till1200px"
            />
...
const fetchProduct = () => {
  product.value = products.find(
    (product) => slugify(product.title) === (route.params.id as string)
  );
};
